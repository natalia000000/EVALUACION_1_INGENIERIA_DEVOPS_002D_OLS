...
Este proyecto corresponde a un microservicio de inventario desarrollado con Spring Boot, aplicado en un entorno DevOps. Incluye integración continua (CI), análisis de seguridad y calidad de código, además de automatización de despliegue mediante GitHub Actions.
...
Push a develop Push a main Pull request hacia main o develop
